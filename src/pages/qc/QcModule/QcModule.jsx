                                            ...
                                            <div className="comments_main_box">
                                                ...
                                                <div className="comments_name_reply_box">
                                                    <div className="name_time_reply_box">
                                                        ...
                                                        <div className="right_time_box" onClick={handleShow}>
                ...
                <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false} centered>
                    <Modal.Body className="modal_body_padding">
                        ...
                        <div className="reason_collect">
                            <div className="row">
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <textarea className="form-control emp_select height_reply" type="text" placeholder="Reply here.." rows="5"></textarea>
                                </div>
                            </div>
                        </div>
