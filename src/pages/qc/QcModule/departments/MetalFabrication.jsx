            ...
            <div className="letter_moulding_content">
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="depth_label">Material Type / Size</div>
                                {IsYesOptionwithEdit && (
                        ...
                        <div className="row mt_workorder">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="depth_label">Stretcheral Support</div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="depth_label">Fixing Methods & Assembly</div>
