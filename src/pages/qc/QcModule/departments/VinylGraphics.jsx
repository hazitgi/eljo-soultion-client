...
export default function VinylGraphics() {
    ...
    return (
        <div>
            <div className="letter_moulding_heading">
                <div>Vinyl / Graphics / ScreenPrinting </div>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="depth_label">Material Specification</div>
                                {IsYesOptionwithEdit && (
                        ...
                        <div className="row mt_workorder">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="depth_label">Print Quality</div>
