...
export default function LetterMoulding({ item }) {
          ...
          <div className="col-lg-6 col-md-6 col-sm-12">
            <div className="row">
              <div className="col-lg-12 col-md-12 col-sm-12">
                <div className="depth_label">Depth of Material</div>
                {IsYesOptionwithEdit && (
                  <div className="depth_label_yes_box">
                    <div className="depth_label_yes">Yes</div>
                    <div
                      className="depth_label_edit"
            ...
            <div className="row mt_workorder">
              <div className="col-lg-12 col-md-12 col-sm-12">
                ...
                {YesNOGreenButton1 && (
                  <div className="yes_no_popup_box">
                    <div
                      className="yes_green_box"
                      onClick={handleshowYesValue1}
                    >
                      <div className="roler_flex">
                        <div>Yes</div>
                      </div>
            ...
            <div className="row mt_workorder">
              <div className="col-lg-12 col-md-12 col-sm-12">
                <div className="depth_label">Edges and Side Finish</div>
                {IsYesOptionwithEdit2 && (
                  <div className="depth_label_yes_box">
                    <div className="depth_label_yes">Yes</div>
                    <div
                      className="depth_label_edit"
                      onClick={handleShowEditOption2}
                    >
                      <AiOutlineEdit />
                    </div>
                  </div>
        ...
        <Modal.Body className="modal_body_padding">
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              ...
              <textarea
                className="form-control emp_select textareas"
                rows="10"
